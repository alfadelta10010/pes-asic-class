...
- Sythesis report:
![synthesis](https://github.com/alfadelta10010/pes-asic-class/blob/main/day2_rtl/assets/mul2_synth_report.png)
- `show` command:
![synthesis](https://github.com/alfadelta10010/pes-asic-class/blob/main/day2_rtl/assets/mul2_show.png)
...
- Sythesis report:
![synthesis](https://github.com/alfadelta10010/pes-asic-class/blob/main/day2_rtl/assets/mul8_synth_report.png)
- `show` command:
![synthesis](https://github.com/alfadelta10010/pes-asic-class/blob/main/day2_rtl/assets/mul8_show.png)
- Netlist dumped by YoSys
```verilog
/* Generated by Yosys 0.32+66 (git sha1 b168ff99d, gcc 11.4.0-1ubuntu1~22.04 -fPIC -Os) */
